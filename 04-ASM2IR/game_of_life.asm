# Game of Life - полная реализация на нашем ASM
# Регистры:
...
# r9: цвет клетки
# r10: временный для вычислений
# r11: временный для вычислений
# r12: временный для вычислений
# r13: временный для вычислений
# r14: временный для вычислений
# r15: временный для вычислений
...
# Подпрограмма для копирования поля next в current
# Использует: r2, r3, r4, r12, r13
copy_field:
    XOR r2, r2, r2
